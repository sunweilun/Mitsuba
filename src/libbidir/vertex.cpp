...
bool PathVertex::perturbPosition(const Scene *scene, Sampler *sampler, Float stddev) {
    ...
    scene->rayIntersectAll(ray, its1);
    ray.d = -ray.d;
...
std::ostream &operator<<(std::ostream &os, PathVertex::EVertexType type) {
    switch (type) {
        case PathVertex::ESensorSupernode: os << "sensorSupernode";
            break;
        case PathVertex::EEmitterSupernode: os << "emitterSupernode";
            break;
        case PathVertex::ESensorSample: os << "sensorSample";
            break;
        case PathVertex::EEmitterSample: os << "emitterSample";
            break;
        case PathVertex::ESurfaceInteraction: os << "surfaceInteraction";
            break;
        case PathVertex::EMediumInteraction: os << "mediumInteraction";
            break;
        case PathVertex::EInvalid: default: os << "invalidType";
            break;
    }
    return os;
}
