    ...
    for (size_t i = 0; i < m_vertices.size(); ++i)
    {
        ...
        switch (vertex->type)
        {
            ...
            case PathVertex::ESensorSupernode: oss << "C";
                break;
            case PathVertex::EEmitterSample: oss << "e";
                break;
            case PathVertex::ESensorSample: oss << "c";
                break;
            case PathVertex::ESurfaceInteraction: oss << "S";
                break;
            case PathVertex::EMediumInteraction: oss << "M";
                break;
            default:
