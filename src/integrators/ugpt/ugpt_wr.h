...
*/
class UGPTWorkResult : public WorkResult {
public:
	const size_t BUFFER_COUNT = 5;

	UGPTWorkResult(const ReconstructionFilter *filter,
	...
	void put(const UGPTWorkResult *workResult);
