...
public:
    ...
    inline Spectrum sample(BSDFSamplingRecord &bRec, Float &_pdf, const Point2 &_sample) const {
        ...
        if (choseSpecular) {
            ...
            bRec.sampledComponent = 0; // This was 1 originally, but I think it is a bug in MTS
            ...
            bRec.sampledComponent = 1;  // This was 0 originally, but I think it is a bug in MTS
    ...
    Float selectionProb(const BSDFSamplingRecord &bRec) const {
        if (bRec.component == 0) return m_specularSamplingWeight;
        return 1 - m_specularSamplingWeight;
    }
    ...
    std::string toString() const {
        ...
        switch (m_modelVariant) {
            case EWard: oss << "ward," << endl;
                break;
            case EWardDuer: oss << "wardDuer," << endl;
                break;
            case EBalanced: oss << "balanced," << endl;
                break;
